"""Drive a whole AOI run on GKE: one k8s Indexed Job per phase (docs/orbae/scale-out.md).
...
That is why there is no Dask cluster and no Argo controller here (see docs/orbae/scale-out.md for
